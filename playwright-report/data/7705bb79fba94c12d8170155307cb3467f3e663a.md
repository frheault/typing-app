...
- Name: Text Handling Functionalities >> Custom Text Input and Display >> Custom text is correctly displayed on practice page with syntax highlighting
- Location: /app/tests/text-handling.spec.ts:44:5
...
Call log:
  - navigating to "/custom-text", waiting until "load"
    ...
    at /app/tests/text-handling.spec.ts:45:18
```
