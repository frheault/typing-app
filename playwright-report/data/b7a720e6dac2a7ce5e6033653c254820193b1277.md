...
- Name: Core Functionalities >> Custom Text Language Selection on Custom Text Page >> Syntax highlighting reflects selected language for custom text
- Location: /app/tests/core-functionalities.spec.ts:184:5
...
Call log:
  - navigating to "/custom-text", waiting until "load"
    ...
    at /app/tests/core-functionalities.spec.ts:185:18
```
