...
- Name: UI Element Verification >> Saved Text Page UI Elements >> Saved text card elements are present (if any saved texts exist)
- Location: /app/tests/ui-elements.spec.ts:112:5

# Error details

```
Error: page.goto: Protocol error (Page.navigate): Invalid url: "/saved-text"
Call log:
  - navigating to "/saved-text", waiting until "load"

    at /app/tests/ui-elements.spec.ts:99:18
```
