...
- Name: UI Element Verification >> Home Page UI Elements >> Create Custom Text button is present
- Location: /app/tests/ui-elements.spec.ts:26:5
...
Call log:
  - navigating to "/", waiting until "load"
    ...
    at /app/tests/ui-elements.spec.ts:7:18
```
