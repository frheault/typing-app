...
- Name: Page Existence and Navigation >> Navbar "Saved Text" link navigates to /saved-text
- Location: /app/tests/navigation.spec.ts:35:3
...
Call log:
  - navigating to "/", waiting until "load"
    ...
    at /app/tests/navigation.spec.ts:36:16
```
