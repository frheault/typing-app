...
- Name: Page Existence and Navigation >> Navbar "Typing Test" link navigates to home page
- Location: /app/tests/navigation.spec.ts:28:3
...
Call log:
  - navigating to "/", waiting until "load"
    ...
    at /app/tests/navigation.spec.ts:29:16
```
