...
- Name: UI Element Verification >> Practice Page UI Elements >> Progress bar is present (if applicable)
- Location: /app/tests/ui-elements.spec.ts:64:5

# Error details

```
Error: page.goto: Protocol error (Page.navigate): Invalid url: "/practice"
Call log:
  - navigating to "/practice", waiting until "load"

    at /app/tests/ui-elements.spec.ts:61:18
```
